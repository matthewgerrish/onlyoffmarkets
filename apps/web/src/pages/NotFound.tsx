...
export default function NotFound() {
  return (
    <div className="container-page py-20 sm:py-32 text-center max-w-xl mx-auto">
      <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-brand-50 text-brand-500 mb-6 animate-pop-in">
        <Compass className="w-8 h-8" />
      </div>
      <div
        className="font-display font-extrabold text-7xl sm:text-8xl text-slate-200 leading-none animate-fade-in-up"
        style={{ animationDelay: '80ms' }}
      >
        404
      </div>
      <h1
        className="mt-3 font-display text-3xl font-extrabold text-brand-navy animate-fade-in-up"
