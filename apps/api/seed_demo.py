...
DEMO_LEADS = [
    # Pierce County NOD — high equity, low LTV (loaded only 130k vs 410k value)
    dict(source="preforeclosure", source_id="pierce-NTS-2026-04122",
         ...
         default_amount=14210, loan_balance=131000,
         estimated_value=412000, assessed_value=378000,
         source_url="https://rd.co.pierce.wa.us/PIERCE/web/Search/DocumentSearch?DocNum=2026-04122"),
    # Maricopa AZ trustee sale — moderate equity
    dict(source="auction", source_id="maricopa-TS-1142",
         ...
         opening_bid=412000, loan_balance=412000,
         estimated_value=685000, assessed_value=602000,
         source_url="https://recorder.maricopa.gov/recdocdata/?docnum=1142"),
    # Fulton GA tax delinquent + code violation — paid-off / very high equity
    dict(source="tax-lien", source_id="fulton-tax-2026-001",
         ...
         estimated_value=268000, assessed_value=240000, loan_balance=0,
    ...
    # Chesapeake VA FSBO — listed 18% below estimated
    dict(source="fsbo", source_id="cl-norfolk-7748112",
         ...
         asking_price=349000, estimated_value=425000, assessed_value=398000, loan_balance=178000,
         source_url="https://norfolk.craigslist.org/reb/d/7748112.html"),
    # Lehigh PA probate — paid-off generational
    dict(source="probate", source_id="lehigh-prob-2026-0214-aa",
         ...
         estimated_value=184000, assessed_value=168000, loan_balance=0,
         source_url="https://www.lccpa.org/probate/case/2026-0214-AA"),
    # Miami-Dade FL absentee — underwater (loan > value, hard deal)
    dict(source="vacant", source_id="miami-attom-503nw22",
         ...
         owner_state="NY",
         estimated_value=478000, assessed_value=445000, loan_balance=440000,
         source_url="https://api.gateway.attomdata.com/property/expandedprofile?address=503+NW+22nd+Ter"),
    # King County WA NOD — moderate LTV
    dict(source="preforeclosure", source_id="king-NOD-2026-1190",
         ...
         default_amount=22480, loan_balance=445000,
         estimated_value=712000, assessed_value=678000,
         source_url="https://recording.kingcounty.gov/search?DocNum=2026-1190"),
    # Thurston WA tax delinquent — older paid-off home
    dict(source="tax-lien", source_id="thurston-tax-2026-0042",
         ...
         estimated_value=318000, assessed_value=295000, loan_balance=42000,
